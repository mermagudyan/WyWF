...
public final class MinecraftWorldContextFactory implements WorldContextFactory {
    ...
    private volatile HolderGetter<NormalNoise> noiseParameters;
    ...
    private synchronized void ensureInit() {
        ...
        HolderLookup.Provider r = VanillaRegistries.createWorldLookup();
        ...
        this.spawnPredictor = new SpawnBlockPredictor();
    ...
    public WorldContext create(long seed, boolean accurateRings) {
        ...
        return new WorldContext(seed, biomeSource, () -> samplerFor(seed),
                ...
                noiseSettings, () -> terrainSamplerFor(seed), () -> randomStateFor(seed));
    }
    ...
    private RandomState randomStateFor(long seed) {
        ensureInit();
        ReusableClimateSampler s = reusableSampler.get();
        s.reseed(seed);
        return s.state();
