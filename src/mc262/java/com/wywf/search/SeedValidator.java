...
public final class SeedValidator {
    ...
    public static int[] findApproxSpawnPos(WorldContext ctx, boolean deep) {
        ...
        // Grid spiral first, MC sampler only if no land found
        ...
        if (spiral != null) {
            ...
            try {
                ...
                if (WyWFDebug.ENABLED) LOGGER.warn("[findApproxSpawnPos] MC sampler failed: {}", t.getMessage());
            }
